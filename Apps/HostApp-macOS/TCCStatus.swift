...
/// on getting **Screen Recording** (for `slopdesk-videohostd`'s screen capture) and
...
///
/// These are CHECKLIST-ONLY for the MVP — the actual video host (`slopdesk-videohostd`) is not
