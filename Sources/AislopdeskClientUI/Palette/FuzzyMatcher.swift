...
// healthy. So we vendor it from source — the same discipline as `CAislopdeskSIMD` (a vendored algorithm
...
// `aislopdesk-fuzzybench`; score/range goldens are pinned by `FuzzyMatcherTests`.
