...
// the parked set to this JSON sidecar on every park/unpark, and the next `aislopdesk-videohostd`
...
public struct WindowParkingSnapshot: Codable, Equatable, Sendable {
    ...
    /// `<AppSupport>/Aislopdesk/parked-windows.json` (beside `EnvBridge`'s `video-prefs.json`).
