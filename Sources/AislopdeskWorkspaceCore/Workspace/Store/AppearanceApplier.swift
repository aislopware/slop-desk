...
public enum AppearanceApplier {
    /// Registered by `AislopdeskClientUI` at app launch. Receives the WHOLE selected ``AppearancePreferences``
    ...
    /// Registered by `AislopdeskClientUI`: returns the CURRENTLY-active theme's terminal-cell palette — the
