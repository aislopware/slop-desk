...
/// `RworkVideoProtocol` — the cross-platform, **pure** wire format for the GUI
...
/// isolation — exactly the same discipline as `RworkProtocol` for PATH 1. The
/// capture/encode (`RworkVideoHost`) and decode/render (`RworkVideoClient`) targets
...
///   (doc 17 §3.9).
public enum RworkVideoProtocol {
