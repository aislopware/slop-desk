...
@MainActor
package enum ConnectionTelemetry {
    ...
    package static func pingMS(_ store: WorkspaceStore) -> Double? {
    ...
    package static func fps(_ store: WorkspaceStore) -> Int? {
    ...
    package static func kbps(_ store: WorkspaceStore) -> Int? {
