...
package enum CodeSidebarFontScheme {
    package static let scheme = "slopdesk-font"

    /// The faces the dressing sheet declares. The raw values are the URL slugs.
    package enum Face: String, CaseIterable {
    ...
    package static func url(for face: Face) -> String {
    ...
    package static func face(forRequest url: URL?) -> Face? {
    ...
    package static func bundledURL(for face: Face) -> URL? {
        switch face {
    ...
    package static func responseHeaders(byteCount: Int) -> [String: String] {
        [
