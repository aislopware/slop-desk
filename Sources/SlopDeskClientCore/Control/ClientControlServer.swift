...
package final class ClientControlServer: @unchecked Sendable {
    ...
    package var onLog: (@Sendable (String) -> Void)?
    ...
    package static let socketEnvVar = "SLOPDESK_CLIENT_SOCKET"
    ...
    private final class BackendBox: @unchecked Sendable {
        package let backend: any ClientControlBackend
        package init(_ backend: any ClientControlBackend) { self.backend = backend }
    }
    ...
    ///     Support default).
    @MainActor
    package init(backend: any ClientControlBackend, socketPath: String = ClientControlServer.resolveSocketPath()) {
    ...
    package static func resolveSocketPath(environment: [String: String] = ProcessInfo.processInfo
        .environment) -> String
    {
    ...
    package static func defaultSocketPath(using fileManager: FileManager = .default) -> String {
...
package enum ClientControlSocketError: Error {
