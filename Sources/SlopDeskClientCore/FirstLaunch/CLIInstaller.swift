...
public final class CLIInstaller {
    ...
    package static func bundledCLIPath() -> String? {
    ...
    package static func isLinkedToBundle() -> Bool {
    ...
    package static func shimFileURL(using fileManager: FileManager = .default) -> URL {
    ...
    package static func singleQuoteForShell(_ value: String) -> String {
        ShellQuoting.singleQuote(value)
    }

    /// Escape `value` for an AppleScript double-quoted string literal (backslash + double-quote).
    package static func escapeForAppleScriptLiteral(_ value: String) -> String {
        value
    ...
    package static func runWithAdmin(shell: String) async -> Bool {
