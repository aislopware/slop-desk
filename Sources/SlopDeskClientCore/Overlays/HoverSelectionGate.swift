...
@MainActor
package final class HoverSelectionGate {
    package init() {}
    ...
    package func admitHover(at location: CGPoint) -> Bool {
    ...
    package func noteHoverDrivenSelection() { selectionIsHoverDriven = true }
    ...
    package func shouldAutoScrollOnSelectionChange() -> Bool {
