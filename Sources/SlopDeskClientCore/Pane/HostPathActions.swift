...
package enum HostPathActions {
    ...
    package static func perform(_ action: Action, path: String, client: MetadataClient?) async -> Bool {
    ...
    package static func performCodeOpen(
    ...
    package static func clear(model: TerminalViewModel) {
