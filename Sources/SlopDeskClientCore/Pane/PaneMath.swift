...
package enum PaneMath {
    ...
    /// last gesture update.
    package static func weightDelta(pixelIncrement: CGFloat, axisSpan: CGFloat, flexSum: CGFloat) -> Double {
    ...
    package static func splitPercents(leading: Double, trailing: Double) -> (leading: Int, trailing: Int)? {
