...
package enum SettingsOptionCatalog {
    // MARK: - Appearance
    ...
    package static let cursorStyles: [SettingsOption<TerminalPreferences.CursorStyle>] = [
    ...
    package static let newTabPositions: [SettingsOption<NewTabPosition>] = [
    ...
    package static let densities: [SettingsOption<String>] = [
    ...
    package static let densityComfortable = "comfortable"
    package static let densityCompact = "compact"
    ...
    package static let optionAsAlt: [SettingsOption<OptionAsAlt>] = [
    ...
    package static let rightClickActions: [SettingsOption<RightClickAction>] = [
    ...
    package static let onLaunch: [SettingsOption<OnLaunchBehavior>] = [
    ...
    package static let closeConfirmation: [SettingsOption<CloseConfirmationPolicy>] = [
    ...
    package static let closeConfirmationTab: [SettingsOption<CloseConfirmationPolicy>] = Array(closeConfirmation
        .prefix(2))
    ...
    package static let windowSizes: [SettingsOption<WindowSizeMode>] = [
    ...
    package static let desktopPresentations: [SettingsOption<DesktopWindowPresentation>] = [
...
package enum SettingsScrollbackLadder {
    package static let range: ClosedRange<Double> = 1000...100_000
    package static let step: Double = 1000
    ...
    package static let presets: [(label: String, value: Double)] = [
        ("1k", 1000),
        ("10k", 10000),
        ("25k", 25000),
        ("50k", 50000),
    ...
    package static func readout(_ lines: Double) -> String {
        "\(grouped(Int(lines.rounded()))) lines"
    }

    /// Group an integer in thousands with a narrow no-break space.
    package static func grouped(_ value: Int) -> String {
...
package enum SettingsScrollMultiplierLadder {
    package static let range: ClosedRange<Double> = 0.25...5
    package static let step: Double = 0.25
    package static let presets: [(label: String, value: Double)] = [
        ("0.5×", 0.5),
        ("1×", 1),
        ("2×", 2),
    ...
    package static func readout(_ multiplier: Double) -> String {
...
package enum SettingsBusyDelayLadder {
    package static let range: ClosedRange<Double> = 0...10
    package static let step: Double = 0.5
    package static let presets: [(label: String, value: Double)] = [
        ("Instant", 0),
        ("1s", 1),
        ("3s", 3),
    ...
    package static func readout(_ seconds: Double) -> String {
