...
struct AndroidBridgeFailure: Error, Equatable {
    let message: String
...
@MainActor
protocol AndroidBridging: AnyObject {
...
@MainActor
final class AndroidBridgeClient: AndroidBridging {
    ...
    static let screenshotLimit = 16 << 20
