...
struct BorderlessDwellGate: Equatable, Sendable {
    ...
    @discardableResult
    mutating func update(pointerYFromTop y: Double, now: TimeInterval) -> Phase {
        switch phase {
        case .hidden:
    ...
    var armingDeadline: TimeInterval? {
