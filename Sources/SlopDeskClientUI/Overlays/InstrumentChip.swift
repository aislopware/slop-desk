...
//   * ``ChipNotice`` — the pure value behind every non-copy cue (tab closed → ⇧⌘T reopens, a jump
//     breadcrumb, Peek & Reply delivered), so wording stays unit-pinnable without a view.
