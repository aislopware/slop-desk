...
//
// SEAM discipline: this view NEVER imports `SlopDeskVideoClient` — discovery crosses the
// `RemoteWindowDiscovery` seam already wired into ``RemoteWindowModel``. Shared `SlopDeskClientUI` view —
