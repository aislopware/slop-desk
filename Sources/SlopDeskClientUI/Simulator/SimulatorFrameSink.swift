...
@MainActor
protocol SimulatorFrameRenderer: AnyObject {
...
@MainActor
final class SimulatorFrameSink {
    ...
    func attach(_ renderer: SimulatorFrameRenderer) {
    ...
    func deliver(configuration: SimulatorWireProtocol.AVCConfiguration) {
