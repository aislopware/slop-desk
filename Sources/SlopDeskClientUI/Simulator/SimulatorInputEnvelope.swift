...
struct SimulatorInputEnvelope: Equatable {
    ...
    static func == (lhs: Self, rhs: Self) -> Bool { lhs.json == rhs.json }
    ...
    static func tap(x: Double, y: Double, duration: Double = 0.05, in surface: Surface) -> Self {
    ...
    static func button(_ name: String, hold: Double = 0) -> Self {
    ...
    static func key(_ code: String, modifiers: [Modifier] = []) -> Self {
    ...
    static func type(_ text: String) -> Self { Self(["type": "type", "text": text]) }
    ...
    static func paste(_ text: String) -> Self { Self(["type": "paste", "text": text]) }

    /// Pull the simulator's current selection onto the host Mac's clipboard.
    static func copy() -> Self { Self(["type": "copy"]) }
