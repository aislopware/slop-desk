...
enum SimulatorStreamMessage: Equatable {
...
enum SimulatorWireProtocol {
    // MARK: Downstream envelope

    static let configurationType: UInt8 = 0x01
    static let keyframeType: UInt8 = 0x02
    static let deltaType: UInt8 = 0x03
    static let jpegType: UInt8 = 0x04
    ...
    /// `byteLength < 2` floor.)
    static func decode(_ message: Data) -> SimulatorStreamMessage? {
    ...
    struct AVCConfiguration: Equatable {
    ...
    static func parseAVCConfiguration(_ record: Data) -> AVCConfiguration? {
    ...
    private struct ByteReader {
        ...
        mutating func blob(length: Int) -> Data? {
        ...
        mutating func readParameterSets(count: Int, into sets: inout [Data]) -> Bool {
            for _ in 0..<count {
