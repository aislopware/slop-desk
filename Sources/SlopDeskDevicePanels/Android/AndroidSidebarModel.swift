...
@MainActor
@Observable
package final class AndroidSidebarModel {
    // MARK: Observable state

    package private(set) var phase: AndroidSidebarPhase = .starting
    package private(set) var devices: [AndroidDevice] = []
    ...
    /// ``AndroidFrameSink``.
    package let frames = AndroidFrameSink()
    ...
    package private(set) var streamSize: CGSize?
    ...
    package private(set) var logLevel: AndroidLogLevel = .info
    ...
    package static func address(of phase: AndroidSidebarPhase) -> (host: String, port: UInt16)? {
    ...
    package func boot(_ device: AndroidDevice) async {
    ...
    package func select(_ key: String?) {
    ...
    package func send(_ messages: [Data]) {
    ...
    package func press(_ keycode: AndroidKeycode) {
    ...
    @discardableResult
    package func console(_ command: String) async -> String? {
    ...
    package func copyScreenshot(of key: String? = nil) async {
    ...
    /// throw away.
    package func setLogLevel(_ level: AndroidLogLevel) {
