...
public final class InspectorServer: @unchecked Sendable {
    ...
    private let queue = DispatchQueue(label: "slopdesk.inspector.listener")
...
/// Errors distinct from `SlopDeskTransportError` for the inspector listener.
...
/// continuation exactly once (mirrors `SlopDeskTransport`'s internal `ReadyBox`, which is
