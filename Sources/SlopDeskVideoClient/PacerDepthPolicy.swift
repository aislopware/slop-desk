...
//
// Why v2 exists (and why v1 — SLOPDESK_ADAPTIVE_JITTER — backfired):
...
public struct PacerDepthPolicy: Sendable, Equatable {
    public struct Config: Sendable, Equatable {
        ...
        /// `SLOPDESK_DEPTH_LATE_SLACK_PCT` (0...100).
        ...
        /// `SLOPDESK_DEPTH_DEMOTE_TOLERANCE` (0...3 — the late ring holds 4).
        ...
        /// `SLOPDESK_DEPTH_WARMUP_MS` (0...30000).
