...
/// pane's ``SlopDeskClient`` channel — its `send` closure targets that channel and its cache is that
...
public final class MetadataClient {
    ...
    /// ``SlopDeskClient/requestMetadata(requestID:verb:payload:)``; a test echoes a canned reply.
