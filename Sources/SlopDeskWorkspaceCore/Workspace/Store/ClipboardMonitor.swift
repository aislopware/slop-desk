...
/// off ``SystemPasteboard/changeCount`` is cheap: a single integer read per tick, and the string is
...
/// and reads the CONTENT only where ``SystemPasteboard/unattendedContentReadIsPermitted``. The phone's
...
public final class ClipboardMonitor {
    ...
    func poll() {
        ...
        if let text = pasteboard.plainText, !text.isEmpty {
