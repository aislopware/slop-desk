...
public enum SettingsKey {
    ...
    /// ⌃⇥ FOLLOW-ALONG PREVIEW — as the switcher's highlight walks, show that pane underneath it
    /// (default ON). Read at step time by ``WorkspaceStore/previewHighlightedPane()``.
    public static let paneSwitcherPreview = "controls.paneSwitcherPreview"
    ...
    /// Whether the ⌃⇥ switcher shows each pane as its highlight walks over it, instead of revealing the
    ...
    public static var paneSwitcherPreviewEnabled: Bool { Defaults[.paneSwitcherPreview] }
