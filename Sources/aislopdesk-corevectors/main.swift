...
// lives solely in the Rust core (aislopdesk_core::capture_region, reached via the C ABI);
...
// (aislopdesk_core::virtual_display_geometry, reached via the C ABI); golden_parity validates the
...
// lives solely in the Rust core (`aislopdesk_core::window_placement`, reached via the C ABI); the
