// aislopdesk-perfbench — headless VideoToolbox encode/decode TIMING benchmark.
//
...
//
// USAGE: aislopdesk-perfbench [--frames N] [--quick] [--bpp X]
...
print("=== aislopdesk-perfbench — Apple M1 Max, headless VT, network removed ===")
