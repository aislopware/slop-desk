...
// directly comparable across SlopDesk and Parsec windows on the same machine.
//
// Usage: slopdesk-framewatch --title <substring> [--seconds 20] [--fps 120] [--list]
//        slopdesk-framewatch --latency --title-a <source> --title-b <client> [--seconds 30]
...
RunLoop.main.run()
#else
fatalError("slopdesk-framewatch is macOS-only")
#endif
