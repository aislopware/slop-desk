...
final class AislopdeskClientBlocksTests: XCTestCase {
    private func makeClient(_ transport: RecordingBlockTransport) -> AislopdeskClient {
        AislopdeskClient(makeTransport: { transport })
    }
