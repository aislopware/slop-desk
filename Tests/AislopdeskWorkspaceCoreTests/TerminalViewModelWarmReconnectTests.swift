...
///
/// With `AISLOPDESK_DETACH_ENABLED` default-ON, a transient link drop detaches the host shell and
...
///
/// The reliable signal is the client's ``AislopdeskClient/SessionResumeOutcome`` (derived from
