...
final class SnippetTests: XCTestCase {
    ...
    // L0: testManageSnippetsIsInThePaletteCatalog was DELETED — it asserted on
    // `CommandPaletteView.commandCatalog`, a static on the deleted SwiftUI ⌘K palette view. The rebuilt
    // command palette (L5) re-pins its catalog contents.
