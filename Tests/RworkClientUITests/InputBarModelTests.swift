...
/// `RworkClaudeCode.InputBoxModel` affordance (A shell / B1 TUI-compose) and drive the dedup
/// ring only in B1. The byte-level logic is `RworkClaudeCode`'s; here we assert the wiring +
/// submit encoding.
@MainActor
