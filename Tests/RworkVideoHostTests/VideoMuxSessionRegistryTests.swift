...
///
/// The session MINTING itself (SCShareableContent + ``RworkVideoHostSession`` + capture/encode) is
...
final class VideoMuxSessionRegistryTests: XCTestCase {
    ...
    private func hello(windowID: UInt32) -> Data {
        VideoControlMessage.hello(protocolVersion: RworkVideoProtocol.version, requestedWindowID: windowID,
