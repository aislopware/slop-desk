...
final class CLIConfigTests: XCTestCase {
    ...
    func testDefaultPathHonorsXDG() {
        ...
        XCTAssertEqual(CLIConfig.resolvePath(override: nil, environment: env), "/cfg/slopdesk/config.toml")
    }

    func testDefaultPathFallsBackToHomeDotConfig() {
        let env = ["HOME": "/Users/me"]
        XCTAssertEqual(CLIConfig.defaultPath(environment: env), "/Users/me/.config/slopdesk/config.toml")
    }
