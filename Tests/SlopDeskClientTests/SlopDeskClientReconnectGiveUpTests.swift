...
final class SlopDeskClientReconnectGiveUpTests: XCTestCase {
    func testReconnectLoopGivesUpAfterExactlyMaxAttempts() async {
        let client = SlopDeskClient(makeTransport: { FailingTransport() })
    ...
    /// its give-up ceiling. A thrown connect does NOT close the client (SlopDeskClient.connect rethrows
