...
final class FramePacerDepthV2Tests: XCTestCase {
    ...
    func testDefaultOffPinsDepthButTelemetryCounts() {
        // adaptiveDepth false at the construction site (SLOPDESK_ADAPTIVE_DEPTH=0).
    ...
    func testManualDepth2IsTelemetryOnly() {
        // Manual SLOPDESK_JITTER_DEPTH=2 + adaptiveDepth: the depth ACTION is disabled (the user
