...
final class PacerDepthPolicyTests: XCTestCase {
    ...
    /// Warmup 0 (env `SLOPDESK_DEPTH_WARMUP_MS=0`) restores the immediate-promote behaviour.
    ...
    func testConfigFromEnvironmentClampsAndDefaults() {
        ...
        let custom = PacerDepthPolicy.Config.fromEnvironment([
            "SLOPDESK_DEPTH_PROMOTE_LATES": "3",
            "SLOPDESK_DEPTH_PROMOTE_WINDOW_MS": "500",
            "SLOPDESK_DEPTH_DEMOTE_MS": "4000",
            "SLOPDESK_DEPTH_MINHOLD_MS": "2000",
            "SLOPDESK_DEPTH_LATE_FACTOR": "2.0",
            "SLOPDESK_DEPTH_IDLE_MS": "350",
            "SLOPDESK_DEPTH_LATE_SLACK_PCT": "50",
            "SLOPDESK_DEPTH_DEMOTE_TOLERANCE": "2",
            "SLOPDESK_DEPTH_WARMUP_MS": "5000",
        ])
        ...
        let clamped = PacerDepthPolicy.Config.fromEnvironment([
            "SLOPDESK_DEPTH_PROMOTE_LATES": "99", // lateTimes ring holds 4
            "SLOPDESK_DEPTH_PROMOTE_WINDOW_MS": "0",
            "SLOPDESK_DEPTH_DEMOTE_MS": "999999",
            "SLOPDESK_DEPTH_LATE_FACTOR": "0.1",
            "SLOPDESK_DEPTH_IDLE_MS": "garbage",
            "SLOPDESK_DEPTH_LATE_SLACK_PCT": "250", // clamp 0...100 → 1.0
            "SLOPDESK_DEPTH_DEMOTE_TOLERANCE": "99", // clamp 0...3
            "SLOPDESK_DEPTH_WARMUP_MS": "999999", // clamp ≤ 30s
        ])
        ...
        let negSlack = PacerDepthPolicy.Config.fromEnvironment(["SLOPDESK_DEPTH_LATE_SLACK_PCT": "-10"])
