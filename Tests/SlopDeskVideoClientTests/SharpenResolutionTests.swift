...
/// W12 P1 — REACHES-CONSUMER for the client unsharp strength (`SLOPDESK_SHARPEN`). Drives the REAL
...
final class SharpenResolutionTests: XCTestCase {
    ...
    func testOverlayReachesSharpenStrength() throws {
        try XCTSkipIf(
            ProcessInfo.processInfo.environment["SLOPDESK_SHARPEN"] != nil,
