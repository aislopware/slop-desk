...
final class LiveCongestionControllerTests: XCTestCase {
    ...
    // MARK: Component 3 — delay-gradient early cut (SLOPDESK_ABR_GRAD, instance-level A/B)

    /// The default ships OFF (HW-feel-test convention) — and these tests assume `SLOPDESK_ABR_GRAD`
    ...
    func testGradientFlagDefaultsOff() {
        XCTAssertFalse(
            ...
            "SLOPDESK_ABR_GRAD must be unset in the test environment; the default ships OFF",
        )
