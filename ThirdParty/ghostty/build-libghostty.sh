...
# for SlopDesk (the ONLY terminal renderer — libghostty-only, no SwiftTerm, no fallback).
#
...
FORKDELTA_PATCH="${SCRIPT_DIR}/slopdesk-libghostty-on-v1.3.1.patch"   # fork delta vs upstream GHOSTTY_TAG
