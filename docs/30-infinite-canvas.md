...
3. Live resize drag driving `GhosttyLayerBackedView.layout()` without retearing (the torn/garbled-render symptom) — same path as the patched window-resize, new trigger.
