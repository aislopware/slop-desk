...
//! on a settings group ([`crate::settings_layout::Platform`], reused here rather than respelled):
//! the Mac's palette asks for the rows a Mac draws, the phone's asks for the phone's, and neither
//! carries a gate.
//!
//! ## What does NOT cross
//!
